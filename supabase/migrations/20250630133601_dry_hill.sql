/*
  ...
  This migration creates an audit logging system for authentication events
  with conditional creation of objects to avoid "already exists" errors.
*/
...
-- Create function to log email changes
DO $$ 
DECLARE
  function_exists boolean;
BEGIN
