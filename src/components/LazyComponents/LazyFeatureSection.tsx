...
const LazyFeatureSection: React.FC<LazyFeatureSectionProps> = ({ features, currentFeature }) => {
  // If features aren't passed, use default features
  ...
  return (
    <section className="py-24 bg-dark-100/50 backdrop-blur-xl content-visibility-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {displayFeatures.map((feature, index) => (
            <div
              key={index}
              className={`group relative p-8 rounded-3xl border-2 transition-all duration-500 transform-gpu hover:shadow-2xl hover:scale-105 ${
